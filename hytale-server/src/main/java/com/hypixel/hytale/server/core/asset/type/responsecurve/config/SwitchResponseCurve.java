...
public class SwitchResponseCurve extends ResponseCurve {
   public static final BuilderCodec<SwitchResponseCurve> CODEC = BuilderCodec.builder(SwitchResponseCurve.class, SwitchResponseCurve::new)
      .documentation(
         "A type of response curve which returns the initial state value before the defined switch point and the final state value after reaching it."
      )
   ...
   public String toString() {
      return "SwitchResponseCurve{initialState="
         + this.initialState
         + ", finalState="
         + this.finalState
         + ", switchPoint="
